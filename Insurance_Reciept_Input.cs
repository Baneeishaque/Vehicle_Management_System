...
{
    public partial class Insurance_Reciept_Input : Form
    {
        ...
        private bool Validation()
        {
            ...
            return isselectedg(new ComboBox[1] { comboBoxvehicle }) && isemptyg(new Control[1] { tam }) && isselectedg(new ComboBox[1] { comboBoxpmode }) && isemptyg(new Control[1] { tdcode }) && iscorrectg(new TextBox[2] { tam,tdcode }) ;
